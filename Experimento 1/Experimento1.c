 ...
 * considerar o * antes de argv.
	Resposta: O argcv indica o número de argumentos que foram passados ao chamar o programa. Já o argv é um vetor que contém esses argumentos. Cada string do argv é um dos parâmetros da linha de comando.
 */
	/*
